...
try:
    # Non-Windows has none of this stuff
    if not salt.utils.platform.is_windows():
        raise OSError

    if os.path.exists(os.path.join(os.environ['SystemRoot'], 'SysNative')):
        bin_path = os.path.join(os.environ['SystemRoot'], 'SysNative')
    else:
        bin_path = os.path.join(os.environ['SystemRoot'], 'System32')
