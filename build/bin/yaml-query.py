...
import yaml, objectpath
import argparse

MAXSTRING = 80

def usage():
    res = argparse.ArgumentParser(prog='yaml-query.py', description='Query some YAML using objectpath syntax.', add_help=True)
